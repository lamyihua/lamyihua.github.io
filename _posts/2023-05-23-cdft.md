...
<img src="{{ "/images/Isotopes_and_half-life.png" | absolute_url }}" alt="Trulli" style="float:center;width:70%"/></span>
<figcaption align = "center">Isotope half-lives (<a href="https://en.wikipedia.org/wiki/Isotope">Wikipedia</a>). <i>Z</i> = number of protons. <i>N</i> = number of neutrons. The stable isotopes deviate from the <i>Z</i> = <i>N</i> line as <i>Z</i> increases causing stronger repulsive Coulomb force, and thus more neutron are needed to increase the attractive strong nuclear force. Image credit: 
<a href="https://en.wikipedia.org/wiki/User:BenRG">BenRG</a>. 
</figcaption>
</figure>

...
<span class="image right"><img src="{{ "/images/SAXJ1808_nicer_burst_final_still.jpg" | absolute_url }}" alt="" /></span>{{<caption>}}Image credit: NASA Goddard Space Flight Center/Chris Smith (USRA){{</caption>}}
